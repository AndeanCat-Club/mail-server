pub fn generate_recovery_html(username: &str, url: &str) -> String {
    let html_template = format!(
        ...
        <div class="main" style="width: 100%; height: 100%;">
            <div style="height: 100px; background-color:#4573ea;">
                <img style="height:70px; border-radius: 200px; margin-top: 15px; margin-left: 15px;" src="https://andeancat.club/wp-content/uploads/2023/09/andean-cat-150x150.png"/>
            </div>
                ...
                <div class="body-container" style="padding-top: 50px; border: 1px solid rgba(0, 0, 0, .1); border-left: 0px; border-right: 0px;">
                    <div class="title-container">
                        <p class="thanks-phrase"
                            ...
                            Intrucciones de recuperación<br> de contraseña!</p>
